...
import { FileText, Code, Box, ChevronRight, Activity, Zap, Terminal } from "lucide-react";
...
export function DocsViewer({ docs }: { docs: DocItem[] }) {
  ...
  return (
    <div className="flex h-screen bg-black text-zinc-100 font-sans overflow-hidden radar-grid relative w-full">
      ...
      {/* Docs Sidebar */}
      <div className="w-64 bg-zinc-950/80 backdrop-blur-md border-r border-white/10 h-screen p-6 flex flex-col z-20 relative">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto p-8 md:p-12 relative z-10 scroll-smooth">
